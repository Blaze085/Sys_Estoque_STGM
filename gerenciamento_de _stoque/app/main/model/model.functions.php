...
class register {
    ...
    // Construtor que inicializa a conexão PDO
    public function __construct($pdo) {
        $this->pdo = $pdo; // Passa a conexão PDO como parâmetro
    }
    ...
    public function setPassword($password) {
        $this->password = $password; // Deve ser um hash, gerado fora da classe se necessário
    }
